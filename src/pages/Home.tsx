      ...
      <main className="w-full h-full flex flex-col gap-8">
        <div className="flex flex-col md:flex-row items-center justify-around px-28 py-28 gap-16">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="md:px-14 py-8 text-center text-neutral-500">
              ...
              for mastering this programming language. Our aim is to empower
              fresh learners with the knowledge and skills necessary to navigate
              the intricacies of C++, setting them on a path to becoming
              successfull.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-around px-28 py-28 gap-16">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="md:px-14 py-8 text-center text-neutral-500">
              Team Andalus, the historic trailblazers, have etched their names
              in the annals of achievement as the first-ever Ethiopian team to
              ...
              achievement serves as a beacon of inspiration for us all. Above
              all, you will be forever remembered as the pioneers—the First Team
              to secure a coveted spot in ACPC and the very First Team to grace
              The World Finals stage! Your journey is a testament to unwavering
